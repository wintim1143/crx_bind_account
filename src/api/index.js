...
export const apiReqs = {
    ...
    kuaishou: {
        getMessageList() {
            const config = {
                url: 'https://luopan.e.kuaishou.com/rest/web/msgList?pageNo=1&pageSize=5',
                method: 'POSt'
            };
            return promiseFetch(config);
        }
    },
...
export function apiRequest(config) {
    ...
    if (config.method.toUpperCase() === 'GET') delete axiosConfig.body;
